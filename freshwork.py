...
import time
dict={} #'d' is the dictionary in which we store data
...
def create(key,value,timeout=0):
    if key in dict:
        ...
        if(key.isalpha()):
            if len(dict)<(1024*1020*1024) and value<=(16*1024*1024): #constraints for file size less than 1GB and Jasonobject value less than 16KB 
